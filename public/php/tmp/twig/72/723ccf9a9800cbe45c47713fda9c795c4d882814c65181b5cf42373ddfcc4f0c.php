...
/* footer.twig */
class __TwigTemplate_0a378dc7e467f7affb6b118521b6728d4c64d3b01f31efd79569fd70619a78b2 extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Git information missing!");
                ...
                // line 25
                echo call_user_func_array($this->env->getFilter('notice')->getCallable(), [$___internal_parse_34_]);
                // line 39
                echo "    </div>
  ";
            }
...
";
    ...
    {
        return new Source("", "footer.twig", "/Applications/XAMPP/xamppfiles/htdocs/ssb_laravel/public/php/templates/footer.twig");
    }
}
