...
class __TwigTemplate_216388c274825cbcd4edcead2f09d32b extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Table comments:");
        ...
        if (( !($context["tbl_is_view"] ?? null) &&  !($context["db_is_system_schema"] ?? null))) {
            // line 13
            echo "            <table class=\"table table-light table-striped table-hover table-sm w-auto caption-top\">
                <caption>";
