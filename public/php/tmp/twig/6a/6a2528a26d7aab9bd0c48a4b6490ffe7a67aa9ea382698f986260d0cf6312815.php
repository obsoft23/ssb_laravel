...
/* login/form.twig */
class __TwigTemplate_3a4340a9810c9722eeff0761f81a8dd257ba117757214ef10a2827084bdcddab extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Username:");
        ...
        echo "\" class=\"form-control\" autocomplete=\"username\">
        </div>
      </div>
...
";
    ...
    {
        return new Source("", "login/form.twig", "/Applications/XAMPP/xamppfiles/htdocs/ssb_laravel/public/php/templates/login/form.twig");
    }
}
