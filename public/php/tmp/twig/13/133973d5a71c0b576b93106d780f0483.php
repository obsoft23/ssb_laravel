...
class __TwigTemplate_48e6a32ff9954eb2b2baf17fa5ba3e8f extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("X-Axis label:");
        ...
        // line 102
        echo twig_escape_filter($this->env, (((($context["xaxis"] ?? null) ==  -1)) ? (_gettext("X Values")) : ((($__internal_compile_3 = ($context["keys"] ?? null)) && is_array($__internal_compile_3) || $__internal_compile_3 instanceof ArrayAccess ? ($__internal_compile_3[($context["xaxis"] ?? null)] ?? null) : null))), "html", null, true);
        echo "\">
        </div>
...
";
    ...
    {
        return new Source("", "table/chart/tbl_chart.twig", "/Applications/XAMPP/xamppfiles/htdocs/ssb_laravel/public/php/templates/table/chart/tbl_chart.twig");
    }
}
